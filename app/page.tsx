    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-[var(--spacing-container)] text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact#rdv"
              className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--color-bleu-logo)] hover:bg-[var(--color-bleu-vif)] text-[var(--color-primary-foreground)] font-heading font-semibold uppercase tracking-widest text-sm rounded-md transition-colors duration-200 shadow-[var(--shadow-bleu)]"
            >
              Prendre rendez-vous
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto px-[var(--spacing-container)] text-center">
          ...
          <Link
            href="/contact#rdv"
            className="inline-flex items-center gap-3 px-10 py-5 bg-[var(--color-bleu-logo)] hover:bg-[var(--color-bleu-vif)] text-[var(--color-primary-foreground)] font-heading font-bold uppercase tracking-widest text-base rounded-md transition-colors duration-200 shadow-[var(--shadow-bleu)]"
          >
            Prendre rendez-vous
