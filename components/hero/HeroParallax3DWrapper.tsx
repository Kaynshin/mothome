...
const HeroParallax3DWrapper = dynamic(
  () => import("./HeroParallax3D"),
  {
    ...
    loading: () => (
      <div
        className="relative min-h-screen bg-[var(--color-noir-profond)] flex items-center justify-center"
        aria-hidden="true"
      >
        <div className="text-center">
          <div className="font-accent text-[clamp(4rem,15vw,12rem)] leading-none text-[var(--color-blanc-casse)]/10 uppercase tracking-wider select-none">
            Mothome
          </div>
        </div>
      </div>
